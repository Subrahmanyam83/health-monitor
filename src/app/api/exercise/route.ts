...
const SEED_DATA: ExerciseData = {
  ...
  exercises: [
    ...
    { id: "14", name: "Side Plank", sets: 3, reps: 20, duration: "~3 min", description: "Strengthens the lateral core (obliques & QL) to stabilise the lumbar spine and reduce side-to-side shear forces on the discs", bodyParts: ["core", "back", "shoulders"], phase: "Activate", order: 10, imageUrl: "https://cdn.motra.com/exercise-assets/9e4ce7ef9c/thumbnailOriginal.jpg" },
