...
const SEED_DATA: ExerciseData = {
  ...
  exercises: [
    { id: "1", name: "Cat-Cow", sets: 2, reps: 10, duration: "~2 min", description: "Lubricates facet joints & wakes up spinal muscles", bodyParts: ["back", "core"], phase: "Warm Up", order: 1 },
    { id: "2", name: "Child's Pose", duration: "60 sec × 2 rounds (~2 min)", description: "Decompresses the lumbar spine & releases the low back", bodyParts: ["back", "hips", "nerve"], phase: "Warm Up", order: 2 },
    { id: "3", name: "Supta Virasana", duration: "90 sec × 1–2 rounds (~2 min)", description: "Lengthens hip flexors to relieve anterior pelvic tilt", bodyParts: ["hips", "legs"], phase: "Release", order: 3 },
    { id: "4", name: "Reclined Spinal Twist", duration: "45 sec each side (~2 min)", description: "Releases QL & paraspinal tension along the spine", bodyParts: ["back", "nerve"], phase: "Release", order: 4 },
    { id: "5", name: "Single Knee-to-Chest + Marching", sets: 2, reps: 10, duration: "~3 min", description: "Decompresses lumbar & trains deep core (TVA) stability", bodyParts: ["back", "core", "nerve"], phase: "Release", order: 5 },
    ...
    { id: "8", name: "Glute Bridge", sets: 3, reps: 12, duration: "~3 min", description: "Activates glutes so the lower back stops compensating", bodyParts: ["legs", "back", "core"], phase: "Activate", order: 8 },
  ],
};
