...
const SEED_DATA: ExerciseData = {
  ...
  exercises: [
    ...
    { id: "10", name: "Supine Spine Decompression", duration: "2–3 min", description: "Lie flat on back, legs spread slightly apart, arms relaxed — lets gravity gently decompress every lumbar disc and release the entire back after a full day", bodyParts: ["back", "hips"], phase: "Night", order: 10, imageUrl: "https://cdn.motra.com/exercise-assets/0b60bffe4c/thumbnailOriginal.jpg" },
    { id: "11", name: "Windshield Wipers", reps: 60, duration: "~2 min", description: "Lying flat on back, rotate both legs together left and right 60 times — mobilises lumbar vertebrae, lubricates facet joints, and relieves stiffness before sleep", bodyParts: ["back", "core", "hips"], phase: "Night", order: 11, imageUrl: "https://cdn.motra.com/exercise-assets/87c5e4291f/thumbnailOriginal.jpg" },
    { id: "12", name: "Supine Figure-4 Stretch", duration: "60 sec each side (~2 min)", description: "Cross one ankle over the opposite knee while lying on back — targets piriformis and outer hip to relieve sciatic nerve compression and SI joint pain", bodyParts: ["hips", "back", "nerve"], phase: "Night", order: 12, imageUrl: "https://cdn.motra.com/exercise-assets/08be8279ad/thumbnailOriginal.jpg" },
    { id: "13", name: "Supine Knee Hug with Twist", reps: 60, duration: "~2 min", description: "Hug both knees to chest then rock gently left and right 60 times — massages the lumbar spine against the floor, releasing accumulated tension before sleep", bodyParts: ["back", "core", "hips"], phase: "Night", order: 13, imageUrl: "https://cdn.motra.com/exercise-assets/888c3ffbd4/thumbnailOriginal.jpg" },
  ],
};
