...
const SEED_DATA: ExerciseData = {
  ...
  exercises: [
    ...
    { id: "7", name: "Supine Figure-4 Spinal Twist", duration: "45 sec each side (~2 min)", description: "Combines hip & spinal release — doubles SI joint decompression", bodyParts: ["back", "hips", "nerve"], phase: "Release", order: 7, imageUrl: "https://cdn.motra.com/exercise-assets/888c3ffbd4/thumbnailOriginal.jpg" },
