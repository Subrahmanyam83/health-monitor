...
export default function AlcoholPage() {
  return (
    <main className="min-h-screen bg-[#f8f9fc]">
      <div className="sticky top-0 z-10" style={{ background: "#4f46e5", paddingTop: "env(safe-area-inset-top)" }}>
        <div className="w-full max-w-md mx-auto px-4 h-14 flex items-center gap-3">
          <Link href="/" className="flex items-center gap-2 text-white transition-colors active:opacity-70">
            ...
            <span className="text-sm font-semibold tracking-tight">SipLog</span>
          </Link>
        </div>
      </div>
